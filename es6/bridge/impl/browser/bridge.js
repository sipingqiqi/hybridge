...
let __tid = 0;
export function openSearch(type, hint, message) {
    return {
        status: true,
        value: '',
        callback() { }
...
export function toggleSearch(isHide) { }
export function SetH5Header(n) {
...
export function leftMenu(n) { }
export function toggleMenu(n, show) { }
export function rightMenu(n) { }
export function articleDetail(url, title, btnTxt) {
    return new Promise((resolve, reject) => {
        resolve('success');
    });
}
export function viewPdf(url, title, btnTxt) {
    return new Promise((resolve, reject) => {
        resolve('success');
    });
}
export function startAudioRec(isShow) {
    return new Promise((resolve, reject) => {
        resolve('success');
    });
}
export function callCamera() {
...
export function tailorCamera(n, bool, width, height) {
    return new Promise((resolve, reject) => {
        resolve('success');
    });
}
...
export function saveImage(base64String) { }
export function getBank() {
    return new Promise((resolve, reject) => {
        resolve('success');
    });
}
export function caSign(name, type, keyWord) {
    let __this = this;
    __this.clearTimer();
...
export function closeWebview(n) { }
export function takeUserImageMultiple(count) {
    this.clearTimer();
    let __this = this;
    let imgs = [];
    function getImg() {
...
export function callCameraMultiple(count) {
    return this.takeUserImageMultiple(count);
}
export function shareShare(type, url, imageUrl, title, desc, callback) {
    return new Promise((resolve, reject) => {
        resolve('success');
    });
}
export function wechatShare(webPageUrl, path, imageUrl, title, desc, callback) { }
export function showShareBtn(type, url, imageUrl, title, desc, callback) { }
export function showShareArr(javascript, url, imageUrl, title, desc) { }
export function showRiskArr(baseImg, fun1, baseImg2, fun2) { }
export function nativeAjax(url, data, method) { }
export function showPosterDetail(param, index) { }
export function sendSms(telNum, content) { }
export function shareShareEntry(type, url, title, desc, callback) { }
