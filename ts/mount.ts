import { Global, global } from './data/global'
...
import { Callback } from './bridge/interface/callback';
...
const callback: Callback = createCallback();

export const mount = function (services: any, vue: any): Global {
